...
// Derived class - Full-time employee (Overrides base class methods)
...
// Derived class - Part-time employee (Overrides base class methods)
...
// Class demonstrating polymorphism (Method Overloading)
class Polymorphism
{
    ...
    public static double CalculateSalary(double wage, double hours)
    {
        return wage * hours;
    }
    ...
    public static void Main()
    {
        ...
        switch (choice)
        {
            case 1:
                ...
                Console.WriteLine($"Total Salary: {CalculateSalary(fullTime.Salary)}");
                break;
            ...
            case 2:
                ...
                Console.WriteLine($"Total Salary: {CalculateSalary(partTime.Wage, partTime.Hours)}");
                break;
